  ...
  const results = [
    {
      ...
      deadline: "10",
      availability: t('home.results.tournament.extraRoom')
    },
    {
              ...
              <div className="d-block px-3" key={index}>
                ...
                <div className="d-flex align-items-center justify-content-start w-100">
                  <span className="border border-color-silver rounded-2 text-green4 px-2 py-2 me-2 text-14">
                    {t('home.results.tournament.deadline')}: {item.deadline} {t('home.results.tournament.daysLeft')}
                  </span>
                  <span className="border border-color-silver rounded-2 text-green4 px-2 py-2 me-2 text-14">
                    {t('home.results.tournament.available')}: {item.availability}
                  </span>
                </div>
              </div>
            ))}
